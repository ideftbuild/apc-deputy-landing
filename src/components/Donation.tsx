...
export default function Donation() {
  return (
    ...
    >
      ...
      <h2 className="text-3xl text-center md:text-start md:text-4xl font-bold text-gray-800 mt-4">
      ...
      <div className="flex flex-col xl:flex-row items-center justify-center h-full">
        ...
        <div className="p-2 text-gray-700">
          <p className="md:text-lg max-w-3xl mx-auto mb-8 text-left">
          ...
          <div className="flex justify-center xl:justify-start">
            <a
              ...
              className="inline-flex items-center  gap-2 px-6 py-3 bg-red-500 text-white font-semibold rounded-full shadow-md hover:bg-red-600 focus:ring-2 focus:ring-red-400 focus:outline-none transition-all duration-200"
